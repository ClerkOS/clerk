...
interface TypeSuggestionCategory {
  category: string;
  prompts: string[];
}
...
const useTypeDetection = (data: SpreadsheetData, range: RangeSelection | null | undefined) => {
  return {
    typeAnalysis: null as TypeAnalysis | null,
    isAnalyzing: false,
    aiContext: '',
...
const Conversation: React.FC<ConversationProps> = ({ onWidthChange, selectedRange, setSelectedRange }) => {
